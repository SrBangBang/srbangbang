...
<div id="install">
  Para una mejor experiencia puedes instalar esta aplicación. Únicamente presiona en el botón
  <img id="share" src="data:image/png;base64,${iOSShareBase64}"> y luego en "Agregar a Inicio".
</div>
