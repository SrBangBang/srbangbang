...
extension UINavigationBar {
    func customNavigationBar() {
        ...
        self.barTintColor = UIColor(rgb: 0x1b0a0a)
...
class ViewController: UIViewController, WKNavigationDelegate, WKUIDelegate, UIDocumentInteractionControllerDelegate, UIGestureRecognizerDelegate {
    ...
    override func loadView() {
        ...
        let back = UIBarButtonItem(title: "Regresar", style: .plain, target: webView, action: #selector(self.webView!.goBack))
       
        self.navigationItem.leftBarButtonItem = back
        self.navigationItem.title = "Soy Tu Salud"
                    ...
                    if status == .authorized {
                        DispatchQueue.main.async { () -> Void in
                            ...
                            let parameters: [String: String] = [
                                "key": "yqcdNBiNHgCsWypiLyUqdTXADNVbEGhg",
                                "app_version": "1.0",
                                "device": "iOS",
    ...
    @objc func LoadWebView() {
        ...
        let url    = URL(string: "https://testing.srbangbang.com")!
    ...
    func documentInteractionControllerViewControllerForPreview(_ controller: UIDocumentInteractionController) -> UIViewController {
        UINavigationBar.appearance().barTintColor = UIColor(rgb: 0x1b0a0a)
        UINavigationBar.appearance().tintColor = UIColor(rgb: 0x1b0a0a)
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedString.Key.foregroundColor : UIColor(rgb: 0x1b0a0a), NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14, weight: UIFont.Weight.bold)]
        return self
    }
    ...
    func webView(_ webView: WKWebView,
        ...
        let downloadable_extensions = ["zip", "7g", "pdf"]
        if(downloadable_extensions.contains(fileextension!))
        {
